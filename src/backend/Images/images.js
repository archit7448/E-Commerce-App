...
const Images = {
    book1: require("../assets/book1.jpg").default,
    book2: require("../assets/book2.jpg").default,
    book3: require("../assets/book3.jpg").default,
    food1: require("../assets/food1.jpg").default,
    ...
    movie3: require("../assets/movie3.jpg").default,
}
